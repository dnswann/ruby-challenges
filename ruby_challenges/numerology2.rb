#ask birthdate
puts "What's your birthdate? Please enter in the format MMDDYYY"
#get birthdate from user
birthdate = gets
#define method to determine birthpath number using birthdate
...
birth_num = get_birthpath(birthdate)

def show_msg_birthpath (birth_num)
...
when 9
	...
	message = "Something has gone awry! Have you entered your birth date in MMDDYYY format?"
	end
end

message = show_msg_birthpath (birth_num)
